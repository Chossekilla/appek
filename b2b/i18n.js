...
const B2B_PHRASES = [
  ...
  // b2b dopreklady v3.0.418 (cookies/GDPR lišta + objednávkový flow) (+30)
  ['Analytické', 'Analytics', 'Analíticas'],
  ['Analytické cookies', 'Analytics cookies', 'Cookies analíticas'],
  ['Dny v týdnu', 'Days of the week', 'Días de la semana'],
  ['Dopravu/poplatek nelze teď spočítat', 'Shipping/fee can\'t be calculated now', 'No se puede calcular ahora el envío/la comisión'],
  ['Faktura + převod', 'Invoice + bank transfer', 'Factura + transferencia'],
  ['Faktury & dobropisy', 'Invoices & credit notes', 'Facturas y abonos'],
  ['Google Analytics (anonymizovaná IP) — měření návštěvnosti. Dobrovolné.', 'Google Analytics (anonymized IP) — traffic measurement. Optional.', 'Google Analytics (IP anonimizada) — medición de tráfico. Opcional.'],
  ['Kurýr', 'Courier', 'Mensajero'],
  ['Nastavení cookies', 'Cookie settings', 'Configuración de cookies'],
  ['Nemáš nastavené žádné místo dodání. Kontaktuj dodavatele, aby ti ho přidal — bez něj nelze objednávku odeslat.', 'You have no delivery location set. Contact your supplier to add one — without it the order can\'t be submitted.', 'No tienes ningún lugar de entrega configurado. Contacta con tu proveedor para que lo añada — sin él no se puede enviar el pedido.'],
  ['Nezbytné', 'Necessary', 'Necesarias'],
  ['Nezbytné cookies', 'Necessary cookies', 'Cookies necesarias'],
  ['Objednávka už je ve výrobě/vyfakturovaná — pošli pekárně žádost o změnu nebo storno', 'The order is already in production/invoiced — send the bakery a change or cancellation request', 'El pedido ya está en producción/facturado — envía a la panadería una solicitud de cambio o cancelación'],
  ['Odmítnout vše', 'Reject all', 'Rechazar todo'],
  ['Odvolání souhlasu', 'Withdrawal of consent', 'Retirada del consentimiento'],
  ['Poplatek za platbu', 'Payment fee', 'Comisión de pago'],
  ['Počet sloupců', 'Number of columns', 'Número de columnas'],
  ['Požádat o změnu / storno', 'Request change / cancellation', 'Solicitar cambio / cancelación'],
  ['Přihlášení, košík, bezpečnost. Bez nich portál nefunguje.', 'Login, cart, security. The portal won\'t work without them.', 'Inicio de sesión, carrito, seguridad. Sin ellas el portal no funciona.'],
  ['Přijmout', 'Accept', 'Aceptar'],
  ['Rozvoz na adresu', 'Delivery to address', 'Entrega a domicilio'],
  ['Tento portál provozuje', 'This portal is operated by', 'Este portal es operado por'],
  ['Uložit volbu', 'Save choice', 'Guardar elección'],
  ['Upravit volbu', 'Edit choice', 'Editar elección'],
  ['Vaše práva (GDPR)', 'Your rights (GDPR)', 'Sus derechos (RGPD)'],
  ['zdarma', 'free', 'gratis'],
  ['Zásady', 'Policy', 'Política'],
  ['Zásady cookies', 'Cookie policy', 'Política de cookies'],
  ['Zásady používání cookies', 'Cookie usage policy', 'Política de uso de cookies'],
  ['Žádná data v tomto období', 'No data in this period', 'No hay datos en este período'],
];
