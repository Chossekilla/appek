...
<style>
  ...
  /* 🆕 Sekční nadpisy — logické seskupení karet */
  .page-master .settings-section-title {
    font-size: 15px; font-weight: 700; color: #1d1d1f;
    margin: 24px 0 10px; padding-bottom: 8px;
    border-bottom: 1px solid #e5e5e7;
    display: flex; align-items: baseline; gap: 8px; flex-wrap: wrap;
  }
  .page-master .settings-section-title:first-of-type { margin-top: 4px; }
  .page-master .settings-section-title small { font-size: 11px; font-weight: 500; color: #86868b; }
</style>
</head>
<body>
...
<main class="page-master">
  ...
  <!-- ══════════════ 💳 PRODEJ LICENCÍ (platby + doručení) ══════════════ -->
  <h2 class="settings-section-title">💳 Prodej licencí <small>platební brány + doručení klíče zákazníkovi e-mailem</small></h2>
  ...
  <!-- ══════════════ 🔐 ÚČET & ZABEZPEČENÍ ══════════════ -->
  <h2 class="settings-section-title">🔐 Účet &amp; zabezpečení</h2>
  <div class="settings-grid">
