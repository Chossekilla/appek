#!/usr/bin/env python3
"""Apply v3.0.418 UI translation backlog (genuine remainder from audit).
...
MARK = 'v3.0.418 dopreklady UI (zbytek auditu: feedy/sezona/tydenni menu/cookies/pobocka/import)'
...
rows = json.load(open(f'{ROOT}/scripts/i18n_new_v418.json', encoding='utf-8'))
entries, skipped = {}, []
for x in rows:
    cs = x['cs'].strip()
