...
// 🧂 LICENSE_SALT — friction-only protection (NE skutečný DRM!).
// ⚠️ v2.6.0 SECURITY NOTE (C2 ve security auditu):
//    Tento salt je v plaintextu v každém customer buildu → attacker s PHP source
//    si může vyrobit platný klíč. Toto JE známé a komentář to přiznává.
//
//    REAL anti-piracy systém je:
//      1. VENDOR HEARTBEAT (v2.1.0+) — denně se hlásí vendoru s license_key + URL.
//         Vendor ověří proti DB. Pokud klíč neexistuje / jiné URL → pirate detected.
//      2. VENDOR-PUBLISHED REVOKATION LIST — customer pull každý spawn z vendor.
//      3. Plán v2.7+: RSA-podepsané license tokens (private key u vendora, public
//         v customer buildu) → cryptographic verifikace bez sdíleného secretu.
//
//    Salt zde slouží jako právní ochrana ("Tampering with this constant violates
//    the license") + odradí 99% náhodných uploadů na hosting.
