...
function demo_pos_users(): array {
    return [
        ...
        // 🆕 v2.9.309 — role 'admin' (ne 'prodavac'), aby Prodavač 1 viděl COMPLETE menu (vč. Výroba, Nastavení, Nástroje, HACCP)
        // pro test scénář demo. POS-only přístup je zachován u Jarmila/Evžen (pos_only=1).
        ['email' => 'prodavac1@demo.cz', 'jmeno' => 'Prodavač 1',         'role' => 'admin',    'pin' => '0000', 'pos_only' => 0, 'heslo' => 'demo1234'],
...
if ($action === 'apply') {
    ...
    try {
        ...
        json_error_safe('Seed selhal', $e, 500);
    }
}
...
if ($action === 'clear') {
    ...
    try {
        ...
        json_error_safe('Clear selhal', $e, 500);
    }
}
