...
(function () {
    ...
    const userHtml = userTpls.length ? userTpls.map(t => `
      <div class="fp-tpl-row">
        ...
        <div class="fp-tpl-actions">
          <button onclick="FP._applyTemplate(${t.id}, 'user')" title="Načíst šablonu (nahradí aktuální rozložení)">📥 Načíst</button>
  ...
  // 🆕 v3.0.246 — apply = vždy clean nahrazení (merge zrušen: hromadil stoly přes zóny → editor přeplněný)
